class GenerateDemoDataJob < ApplicationJob
  ...
  def generate_products
    product_data = [
      { title: 'Wireless Headphones', type: 'Electronics', vendor: 'TechGear', variants: ['Black', 'White', 'Blue'] },
      { title: 'Organic Coffee Beans', type: 'Food & Beverage', vendor: 'RoastMaster', variants: ['Light Roast', 'Medium Roast', 'Dark Roast'] },
      { title: 'Yoga Mat', type: 'Fitness', vendor: 'ZenFit', variants: ['Standard', 'Extra Thick'] },
      { title: 'Leather Wallet', type: 'Accessories', vendor: 'CraftLeather', variants: ['Brown', 'Black', 'Tan'] },
      { title: 'Smart Watch', type: 'Electronics', vendor: 'TechGear', variants: ['40mm', '44mm'] },
      { title: 'Running Shoes', type: 'Footwear', vendor: 'SpeedRun', variants: ['Size 8', 'Size 9', 'Size 10', 'Size 11'] },
      { title: 'Desk Lamp', type: 'Home Office', vendor: 'LightWorks', variants: ['White', 'Black'] },
      { title: 'Reusable Water Bottle', type: 'Accessories', vendor: 'EcoLife', variants: ['500ml', '750ml', '1L'] },
      { title: 'Bluetooth Speaker', type: 'Electronics', vendor: 'SoundWave', variants: ['Mini', 'Standard', 'XL'] },
      { title: 'Cotton T-Shirt', type: 'Apparel', vendor: 'BasicWear', variants: ['S', 'M', 'L', 'XL'] }
    ]
  ...
  def generate_inventory
    ...
    variants.each_with_index do |variant, index|
      locations.each do |location|
        ...
        if inventory_level.available <= @store.low_stock_threshold
  ...
  def generate_orders
    ...
    customer_names = [
      ...
      ['Emily', 'Williams'], ['Michael', 'Brown'], ['Sarah', 'Davis'],
      ['David', 'Miller'], ['Jessica', 'Wilson'], ['Chris', 'Moore'],
      ['Amanda', 'Taylor']
    ]
